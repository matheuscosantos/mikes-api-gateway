...
resource "aws_api_gateway_deployment" "mikes-api-gateway-deployment" {
  depends_on = [
    ...
    aws_api_gateway_integration.get_order_by_id_integration
  ]
  rest_api_id = aws_api_gateway_rest_api.mikes_api_gateway.id
  stage_name  = "dev"
}
...
resource "aws_api_gateway_method" "delete_variable_id_customer_method" {
  rest_api_id   = aws_api_gateway_rest_api.mikes_api_gateway.id
  resource_id   = aws_api_gateway_resource.variable_customer_resource.id
  http_method   = "DELETE"
  authorization = "COGNITO_USER_POOLS"
...
resource "aws_api_gateway_integration" "delete_variable_customer_integration" {
  rest_api_id             = aws_api_gateway_rest_api.mikes_api_gateway.id
  resource_id             = aws_api_gateway_resource.variable_customer_resource.id
  http_method             = aws_api_gateway_method.delete_variable_id_customer_method.http_method
...
resource "aws_api_gateway_method" "put_variable_id_product_method" {
  rest_api_id   = aws_api_gateway_rest_api.mikes_api_gateway.id
...
resource "aws_api_gateway_method" "delete_variable_id_product_method" {
  rest_api_id   = aws_api_gateway_rest_api.mikes_api_gateway.id
  resource_id   = aws_api_gateway_resource.variable_id_product_resource.id
  http_method   = "DELETE"
  authorization = "COGNITO_USER_POOLS"
...
resource "aws_api_gateway_integration" "put_product_integration" {
  rest_api_id             = aws_api_gateway_rest_api.mikes_api_gateway.id
  resource_id             = aws_api_gateway_resource.variable_id_product_resource.id
  http_method             = aws_api_gateway_method.put_variable_id_product_method.http_method
...
resource "aws_api_gateway_integration" "delete_product_integration" {
  rest_api_id             = aws_api_gateway_rest_api.mikes_api_gateway.id
  resource_id             = aws_api_gateway_resource.variable_id_product_resource.id
  http_method             = aws_api_gateway_method.delete_variable_id_product_method.http_method
  integration_http_method = "DELETE"
  type                    = "HTTP_PROXY"
...
# -- ------------------------------------------------------
# -- route orders payment #todo : não sera usado pela peca de pedido
# -- ------------------------------------------------------
